...
- [x] P5 relink/freshness (shared pure matcher, case-proofed SQL, scoped ingest relink, unified freshness w/ group exclusion) · [x] P6 route consolidation (requireUserApi, ownership guard, error codes; orch added candidate_already_resolved mapping) · [ ] P8 UI consolidation (agent running)
- [x] P7 ingest extraction (lib/sync/mac-agent.ts, batched upserts, reverse-map; 188 tests) · [ ] P9 contact page
